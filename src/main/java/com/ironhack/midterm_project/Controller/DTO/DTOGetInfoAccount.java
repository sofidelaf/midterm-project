...
public class DTOGetInfoAccount {
    ...
    public DTOGetInfoAccount(Long id, Money balance, String primaryOwnerName, String secondaryOwnerName, String secretKey, Money minimumBalance) {
        this.id = id;
